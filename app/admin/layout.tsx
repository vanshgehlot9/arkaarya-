...
import { LayoutDashboard, Users, Briefcase, Truck, FileText, Settings, DollarSign, LogOut, Building2, HeartHandshake, Star, BarChart } from "lucide-react";
...
export default async function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-[#F8FAF7] flex">
      {/* Sidebar Navigation */}
      <aside className="w-64 bg-white border-r border-[#E3E8E4] flex flex-col fixed inset-y-0 z-10 overflow-y-auto">
        <div className="p-6">
          <Link href="/admin" className="flex items-center gap-2 mb-8">
            <div className="w-8 h-8 rounded-full bg-[#00264A]"></div>
            <span className="text-xl font-bold text-[#00264A]">ArkaArya</span>
          </Link>
